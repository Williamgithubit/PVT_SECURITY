...
import icon from "../../public/Asserts/arrow dropdown.svg";
// import Logo from "../Asserts/Off_Duty_Logo.png"
...
const Header = () => {
  ...
  return (
    <Fragment>
      <header className="bg-white flex items-center w-full pl-0 pr-0 fixed top-0 left-0 h-auto md:h-20 z-10 shadow-md">
        <div className="w-full px-4 py-4 flex justify-between items-center">
          {/* Logo/Brand - Add your logo here */}
          <div className="text-xl font-bold">
            <Link to="/" >PVT <span className="text-blue-700">SECURITY</span></Link>
          </div>
            ...
            <ul className="flex flex-col md:flex-row gap-2 md:gap-8 p-4 md:p-0">
              ...
              <li className="relative">
                <button
                  ...
                  className="text-[18px] w-full md:w-auto flex items-center justify-between hover:text-blue-700 hover:underline py-2 md:py-0"
                >
                  About Us
